...
State/Reducer: 保存两个列表。保存的话，一个是Scheduled，有开始时间节点，一个是todo，没有时间，开启就添加。

增、删、改等基础技能。

增：有时间的加Scheduled List，没时间的加Todo List

删：List 为基础的 Edit

改：

- 改状态：Scheduled 当中 Check/Uncheck
- 改状态：todo 当中 Check
- 改状态：Stash ，整合到时间按钮里
- 改状态：todo 当中开始一个任务。
- 改时间：整合到时间按钮里。之后需要重新排序。
- 改内容：想想办法实现
